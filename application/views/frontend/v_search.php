...
<div class="intro intro-single route bg-image" 
  ...
  <div class="intro-content d-flex align-items-center">
    <div class="container text-center">
      ...
      <h2 class="intro-title mb-3">Pencarian Artikel</h2>
...
<!-- BLOG SEARCH RESULT SECTION -->
<section class="page-section py-5" id="blog">
  <div class="container">
    <div class="row">
...
<!-- END BLOG SEARCH RESULT SECTION -->


<!-- STYLING (SAMA DENGAN HALAMAN LAIN) -->
<style>
/* INTRO SECTION */
.intro-single {
    position: relative;
